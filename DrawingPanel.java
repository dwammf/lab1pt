...
public class DrawingPanel extends JPanel {
  ...
  //  private int regEdges = 0;
    ...
    public DrawingPanel(JFrame window){
        ...
        Menu shape1D = new Menu("1D Figures");
        Menu shape2D = new Menu("2D Figures");
        Menu polygon = new Menu("Polygons");
        for (FigureType t : FigureType.values()) {
         ...
         //               regEdges = (int) spinner.getValue();
            ...
            switch (t.clazz) {
                case FigureType.SHAPE_D1:
                    shape1D.add(item);
                    break;
                case FigureType.SHAPE_D2:
                    shape2D.add(item);
                    break;
...
//                    else {
//                        Shape1D shape = new RegularPolygon(regEdges, points.get(0), points.get(1));
